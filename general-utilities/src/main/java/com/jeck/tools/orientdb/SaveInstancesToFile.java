...
//        System.out.println("result size: " + resultSet.stream().count());
    ...
    public static void saveToFile(ODatabaseDocument database, String tableName, String filePath, String[] columns) throws IOException {
...
//        System.out.println("result size: " + resultSet.stream().count());
    ...
    public static void saveToFileAll(ODatabaseDocument database, String tableName, String filePath) throws IOException {
