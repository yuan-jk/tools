...
//
//    @Test
//    void testScanInvalidQualifiedTable() {
//        // Equivalent SQL:
//        //   SELECT *
//        //   FROM "scott"."zzz"
//        try {
...
//
//    @Test
//    void testScanValidTableWrongCase() {
//        // Equivalent SQL:
//        //   SELECT *
//        //   FROM "emp"
//        try {
...
//
//    @Test
//    void testScanFilterTriviallyFalse() {
//        // Equivalent SQL:
//        //   SELECT *
//        //   FROM emp
//        //   WHERE 1 = 2
...
//
//    @Test
//    void testScanFilterGreaterThan() {
//        // Equivalent SQL:
//        //   SELECT *
//        //   FROM emp
//        //   WHERE deptno > 20
...
//
//    @Test
//    void testSnapshotTemporalTable() {
//        // Equivalent SQL:
//        //   SELECT *
...
//
//    @Test
//    void testTableFunctionScanZeroInputs() {
//        // Equivalent SQL:
//        //   SELECT *
//        //   FROM TABLE(RAMP(3))
//        final RelBuilder builder = RelBuilder.create(config().build());
...
//     */
//    @Test
//    void testTableFunctionScanDynamicType() {
//        // Equivalent SQL:
//        //   SELECT *
...
//     */
//    @Test
//    void testScanFilterDuplicateAnd() {
//        // Equivalent SQL:
//        //   SELECT *
//        //   FROM emp
...
//     */
//    @Test
//    void testProjectIdentityWithFieldsRename() {
//        final RelBuilder builder = RelBuilder.create(config().build());
//        RelNode root =
//                builder.scan("DEPT")
...
//     */
//    @Test
//    void testProjectIdentityWithFieldsRenameFilter() {
//        final RelBuilder builder = RelBuilder.create(config().build());
//        RelNode root =
//                builder.scan("DEPT")
//                        .project(builder.alias(builder.field(0), "a"),
...
//
//    @Test
//    void testProjectWithAliasFromScan() {
//        final RelBuilder builder = RelBuilder.create(config().build());
//        RelNode root =
//                builder.scan("EMP")
...
//     */
//    @Test
//    void testAggregateAndThenProjectNamedField() {
//        final Function<RelBuilder, RelNode> f = builder ->
//                builder.scan("EMP")
...
//     */
//    @Test
//    void testAggregateEliminatesDuplicateCalls() {
//        final String expected = ""
...
//     */
//    @Test
//    void testAggregateEliminatesDuplicateCalls2() {
...
//     */
//    @Test
//    void testAggregateEliminatesDuplicateCalls3() {
...
//     */
//    @Test
//    void testAggregateEliminatesDuplicateDistinctCalls() {
//        final RelBuilder builder = RelBuilder.create(config().build());
//        RelNode root = builder.scan("EMP")
...
//     */
//    @Test
//    void testAggregateProjectWithAliases() {
//        final RelBuilder builder = RelBuilder.create(config().build());
//        RelNode root =
//                builder.scan("EMP")
//                        .project(builder.field("DEPTNO"))
...
//
//    @Test
//    void testAggregateGroupingKeyOutOfRangeFails() {
//        final RelBuilder builder = RelBuilder.create(config().build());
//        try {
//            RelNode root =
//                    builder.scan("EMP")
...
//
//    @Test
//    void testAggregateGroupingSetNotSubsetFails() {
//        final RelBuilder builder = RelBuilder.create(config().build());
//        try {
//            RelNode root =
//                    builder.scan("EMP")
...
//     */
//    @Test
//    void testAggregateGroupingSetDuplicate() {
//        final RelBuilder builder = RelBuilder.create(config().build());
//        RelNode root =
//                builder.scan("EMP")
//                        .aggregate(
...
//     */
//    @Test
//    void testGroupingSetWithGroupKeysContainingUnusedColumn() {
//        final RelBuilder builder = RelBuilder.create(config().build());
//        RelNode root = builder.scan("EMP")
//                .aggregate(
//                        builder.groupKey(
...
//
//    @Test
//    void testAggregateGroupingWithDistinctFails() {
//        final RelBuilder builder = RelBuilder.create(config().build());
//        try {
//            RelNode root =
//                    builder.scan("EMP")
...
//
//    @Test
//    void testAggregateGroupingWithFilterFails() {
//        final RelBuilder builder = RelBuilder.create(config().build());
//        try {
//            RelNode root =
//                    builder.scan("EMP")
...
//     */
//    @Test
//    void testAggregateGroupingSetsOneRow() {
//        final Function<RelBuilder, RelNode> f = builder -> {
...
//     */
//    @Test
//    void testBadUnionArgsErrorMessage() {
//        // Equivalent SQL:
...
//     */
//    @Test
//    void testJoinConditionSimplification() {
//        final Function<RelBuilder, RelNode> f = b ->
//                b.scan("EMP")
//                        .scan("DEPT")
//                        .join(JoinRelType.INNER,
...
//     */
//    @Test
//    void testProjectExceptWithOrdinal() {
//        final RelBuilder builder = RelBuilder.create(config().build());
//        RelNode root =
//                builder.scan("EMP")
//                        .projectExcept(
...
//     */
//    @Test
//    void testProjectExceptWithName() {
//        final RelBuilder builder = RelBuilder.create(config().build());
//        RelNode root =
//                builder.scan("EMP")
//                        .projectExcept(
...
//     */
//    @Test
//    void testProjectExceptWithExplicitAliasAndName() {
//        final RelBuilder builder = RelBuilder.create(config().build());
//        RelNode root =
//                builder.scan("EMP")
//                        .as("e")
...
//     */
//    @Test
//    void testProjectExceptWithImplicitAliasAndName() {
//        final RelBuilder builder = RelBuilder.create(config().build());
//        RelNode root =
//                builder.scan("EMP")
//                        .projectExcept(
...
//     */
//    @Test
//    void testProjectExceptWithDuplicateField() {
//        final RelBuilder builder = RelBuilder.create(config().build());
//        IllegalArgumentException ex = assertThrows(IllegalArgumentException.class, () -> {
//            builder.scan("EMP")
//                    .projectExcept(
...
//     */
//    @Test
//    void testProjectExceptWithMissingField() {
//        final RelBuilder builder = RelBuilder.create(config().build());
//        builder.scan("EMP");
...
//     */
//    @Test
//    void testFieldOnNonStructExpression() {
//        final RelBuilder builder = RelBuilder.create(config().build());
...
//
//    @Test
//    void testValuesBadNullFieldNames() {
//        try {
//            final RelBuilder builder = RelBuilder.create(config().build());
...
//     */
//    @Test
//    void testRunValues() throws Exception {
//        // Equivalent SQL:
//        //   VALUES (true, 1), (false, -50) AS t(a, b)
//        final RelBuilder builder = RelBuilder.create(config().build());
//        RelNode root =
...
//     */
//    @Test
//    void testTypeInferenceValidation() {
//        final RelBuilder builder = RelBuilder.create(config().build());
...
//     */
//    @Test
//    void testFilterWithCorrelationVariables() {
//        final RelBuilder builder = RelBuilder.create(config().build());
//        final Holder<@Nullable RexCorrelVariable> v = Holder.empty();
//        RelNode root = builder.scan("EMP")
//                .variable(v)
...
//     */
//    @Test
//    void testExpandViewInRelBuilder() throws SQLException {
...
//
//    @Test
//    void testExpandViewShouldKeepAlias() throws SQLException {
//        try (Connection connection = DriverManager.getConnection("jdbc:calcite:")) {
//            final Frameworks.ConfigBuilder configBuilder =
//                    expandingConfig(connection);
//            final RelOptTable.ViewExpander viewExpander =
...
//
//    @Test
//    void testExpandTable() throws SQLException {
//        try (Connection connection = DriverManager.getConnection("jdbc:calcite:")) {
...
//
//    @Test
//    void testSimpleSemiCorrelateViaJoin() {
...
//
//    @Test
//    void testSimpleSemiCorrelateViaJoinWithoutConvertCorrelateToJoin() {
//        final Function<RelBuilder, RelNode> f = b ->
...
//
//    @Test
//    void testSimpleAntiCorrelateViaJoin() {
...
//
//    @Test
//    void testSimpleAntiCorrelateViaJoinWithoutConvertCorrelateToJoin() {
//        final Function<RelBuilder, RelNode> f = b ->
...
//
//    @Test
//    void testSimpleLeftCorrelateViaJoin() {
...
//
//    @Test
//    void testSimpleLeftCorrelateViaJoinWithoutConvertCorrelateToJoin() {
//        final Function<RelBuilder, RelNode> f = b ->
...
//
//    @Test
//    void testSimpleInnerCorrelateViaJoin() {
...
//
//    @Test
//    void testSimpleInnerCorrelateViaJoinWithoutConvertCorrelateToJoin() {
//        final Function<RelBuilder, RelNode> f = b ->
...
//
//    @Test
//    void testSimpleRightCorrelateViaJoinThrowsException() {
...
//
//    @Test
//    void testSimpleFullCorrelateViaJoinThrowsException() {
//        assertThrows(IllegalArgumentException.class,
...
//
//    @Test
//    void testRightCorrelateViaJoinThrowsException() {
//        assertThrows(IllegalArgumentException.class,
...
//
//    @Test
//    void testFullCorrelateViaJoinThrowsException() {
//        assertThrows(IllegalArgumentException.class,
...
//
//    @Test
//    void testCorrelateWithComplexFields() {
//        final RelBuilder builder = RelBuilder.create(config().build());
//        final Holder<@Nullable RexCorrelVariable> v = Holder.empty();
//        RelNode root = builder.scan("EMP")
//                .variable(v)
...
//
//    @Test
//    void testAdoptConventionEnumerable() {
//        final RelBuilder builder = RelBuilder.create(config().build());
//        RelNode root = builder
...
//     */
//    @Test
//    void testEmptyValuesWithCollation() throws Exception {
//        final RelBuilder builder = RelBuilder.create(config().build());
//        final RelNode root =
//                builder
//                        .scan("DEPT").empty()
...
//        Blog
//        About
//        calcite/RelBuilderTest.java at main · apache/calcite